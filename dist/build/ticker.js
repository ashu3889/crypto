 ...
 */
var KiteTicker = function KiteTicker(api_key, user_id, public_token, address) {
	if (!address) {
  ...
  */
	this.connect = function () {
		...
		ws = new WebSocket(address + "?api_key=" + api_key + "&user_id=" + user_id + "&public_token=" + public_token + "&uid=" + new Date().getTime().toString());
