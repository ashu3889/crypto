    ...
    if (spreadValue > 2 * tickSize) {
      ...
      if (bidsArray.length > 1 && bidsQuantity.length > 1) {
        ...
        for (var i = 0; i < bidsArray.length; i++) {
          ...
          var _pricedata = parseFloat(bidsArray[i].toFixed(4));
          ...
          var data = _defineProperty({ 'quantity': value.Qty, 'cm': _cmdata, 'price': _pricedata, 'instrument': instrumentName }, 'cm', cm);
      ...
      if (asksArray.length > 1 && asksQuantity.length > 1) {
        for (var i = 0; i < asksArray.length; i++) {
          ...
          var _pricedata2 = parseFloat(asksArray[i].toFixed(4));
          ...
          var data = { 'quantity': value.Qty, 'cm': _cmdata2, 'price': _pricedata2, 'instrument': instrumentName };
          optiondata[globalindex].CleanedSellOrderBook.push(data);
        }
      }
      ...
      if (bidsArray.length > 1 && bidsQuantity.length > 1) {
        ...
        for (var i = 0; i < bidsArray.length; i++) {
          ...
          var data = _defineProperty({ 'quantity': value.Qty, 'cm': _cmdata3, 'price': _pricedata3, 'instrument': instrumentName }, 'cm', cm);
          optiondata[globalindex].CleanedBuyOrderBook.push(data);
        }
      }
    } else {
